...
export default function HojaVidaCard({ hoja, onEdit, onDelete }) {
        ...
        {(onEdit || onDelete) && (
          <div className="flex justify-end gap-2 mt-4 pt-3 border-t border-slate-100">
            ...
            {onDelete && (
              <button
                type="button"
                onClick={() => onDelete(hoja)}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-rose-700 border border-rose-200 rounded-lg hover:bg-rose-50"
              >
                <IconoTacho /> Eliminar
              </button>
            )}
