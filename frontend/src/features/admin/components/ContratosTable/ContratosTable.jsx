...
export default function ContratosTable({ contratos = [], loading = false, error = null, onSearch, onAnexo, onFiniquitar, onIndefinido, onAdministrarInstalaciones, onVerDocumentos }) {
        ...
        <table className={styles.table}>
          ...
          <tbody>
            ...
            {!loading && !error && contratos.map((contrato) => (
              <ContratoRow key={contrato.id} contrato={contrato} onAnexo={onAnexo} onFiniquitar={onFiniquitar} onIndefinido={onIndefinido} onAdministrarInstalaciones={onAdministrarInstalaciones} onVerDocumentos={onVerDocumentos} />
            ))}
          </tbody>
        </table>
      </div>
