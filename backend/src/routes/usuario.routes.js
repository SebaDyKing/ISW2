...
import { crearUsuario, obtenerUsuarios, obtenerUsuario, actualizarUsuario, eliminarUsuario, obtenerEmpleados, obtenerClientes } from "../controllers/usuario.controller.js";
...
router.get("/clientes", authMiddleware, autorizeEntities("administrador"), obtenerClientes);
